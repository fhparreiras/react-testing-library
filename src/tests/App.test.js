...
describe('Testes do componente APP', () => {
  test('O topo da aplicação deve conter os links: Home, About, Favorite Pokémons', () => {
  ...
  test('Ao clicar no link Home,deve aparecer a página inicial com a URL "/"', () => {
    renderWithRouter(<App />);
  ...
  test('Ao entrar em uma URL desconhecida, renderiza a página Not Found', () => {
    const { history } = renderWithRouter(<App />);
